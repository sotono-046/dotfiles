---
name: tmux-ide
description: Use tmux-ide to set up, validate, modify, and debug tmux-powered terminal IDE layouts, including multi-pane development workspaces and Claude Code agent team sessions driven by ide.yml.
---
