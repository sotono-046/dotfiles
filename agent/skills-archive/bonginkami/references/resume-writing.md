...
|---|---|---|---|
| 1 | 役割 | 50 characters | 60 characters |
| 2 | 行動 | 70 characters | 80 characters |
| 3 | 成果 | 90 characters | 100 characters |
...
This configuration fits 2 pages with the bundled Noto Sans JP gothic stack. A different system font can shift line metrics slightly; run `--verify` after any font environment change.
